...
public class DeviceAdminDemoReceiver extends DeviceAdminReceiver {
	...
	public void onEnabled(Context context, Intent intent) {
		...
		SharedPreferences sharedPerf = context.getSharedPreferences("mSFAGeoPreference", MODE_MULTI_PROCESS);
		SharedPreferences.Editor editor = sharedPerf.edit();
		editor.putString("dmp_status","1" );
		editor.apply();
		editor.commit();

		Log.d(CNAME, "onEnabled"+sharedPerf.getString("dmp_status","0"));
	}
	...
	public void onDisabled(Context context, Intent intent) {
		...
		SharedPreferences sharedPerf = context.getSharedPreferences("mSFAGeoPreference", MODE_MULTI_PROCESS);
		SharedPreferences.Editor editor = sharedPerf.edit();
		editor.putString("dmp_status","0" );
		editor.commit();
		editor.apply();

		Log.d(CNAME, "onDisabled"+sharedPerf.getString("dmp_status","77"));
	}
}